...
const gigs = [
  { id: 1, title: "I will audit your Solana Rust Smart Contract", user: "@0xAuditor", rating: 4.9, price: 100, cat: "Audits" },
  { id: 2, title: "Build a custom NFT minting dApp with React", user: "@0xDev", rating: 4.8, price: 250, cat: "Smart Contracts" },
  { id: 3, title: "Design your DeFi protocol dashboard UI/UX", user: "@CryptoDesign", rating: 5.0, price: 180, cat: "UI/UX Design" },
  { id: 4, title: "Write & deploy ERC-20 token on Ethereum", user: "@SolidityPro", rating: 4.7, price: 120, cat: "Smart Contracts" },
  { id: 5, title: "Manage your Discord & Twitter community", user: "@Web3CM", rating: 4.6, price: 80, cat: "Community Management" },
  { id: 6, title: "Create animated Web3 landing page", user: "@PixelChain", rating: 4.9, price: 200, cat: "UI/UX Design" },
  { id: 7, title: "Smart contract security audit & report", user: "@AuditDAO", rating: 5.0, price: 500, cat: "Audits" },
  { id: 8, title: "Build Telegram trading bot for Solana", user: "@BotBuilder", rating: 4.8, price: 300, cat: "Smart Contracts" },
];
          ...
          >
            ...
            <div className="h-36 bg-secondary flex items-center justify-center">
              <div className="h-10 w-10 rounded-lg bg-primary/20 flex items-center justify-center">
                <span className="text-primary text-lg font-bold">{gig.cat[0]}</span>
              </div>
            </div>
